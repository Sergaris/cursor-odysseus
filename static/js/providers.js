...
const _PROVIDERS = [
  ...
  // Cursor SDK / Composer
  [/cursor-sdk|composer-2\.5|composer-2/i,
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3 4 7v6c0 5 3.5 8 8 8s8-3 8-8V7l-8-4z"/><path d="M9 12l2 2 4-4"/></svg>'],
